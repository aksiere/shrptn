<script>
	...
	const educations = [
		...
		{ title: 'Битрикс-1С, администрирование сайта, лендинги (самописные + тильда)', university: 'АВТОПОЛЕ', quali: '1С-Битрикс, администрирование сайта, лендинги (самописные + тильда)', started: 2020, ended: 2021 },
