<script>
	...
	const educations = [
		...
		{ title: 'Ассистент (отдел маркетинга и рекламы)', university: 'АВТОПОЛЕ', quali: '1С-Битрикс, администрирование сайта,<br>лендинги (самописные + тильда)', started: 2020, ended: 2021 },
