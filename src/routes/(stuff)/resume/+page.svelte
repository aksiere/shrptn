<script>
	...
	const educations = [
		...
		{ title: 'Ассистент (отдел маркетинга и рекламы)', university: 'АВТОПОЛЕ', quali: 'Битрикс-1С, администрирование сайта, лендинги (самописные + тильда)', started: 2020, ended: 2021 },
