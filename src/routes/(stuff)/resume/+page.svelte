<script>
	...
	const educations = [
		...
		{ title: '1С-Битрикс, администрирование сайта, лендинги (самописные + тильда)', university: 'АВТОПОЛЕ', quali: 'Ассистент (отдел маркетинга и рекламы)', started: 2020, ended: 2021 },
