<script>
	...
	const components = [
		{ href: 'https://frasera.shrptn.me', title: 'Drawer', desc: 'выдвигающийся компонент, может использоваться в качестве замены модальному окну на мобильных устройствах.' },
	]
</script>
